...
<p align="left"> 
 Atualmente, atuo no desenvolvimento de sistemas governamentais estratégicos, contribuindo para soluções que beneficiam diretamente programas sociais. <br>
 Tenho experiência sólida em desenvolvimento fullstack, com foco em PHP (Laravel), React, integrações com APIs REST, testes automatizados e pipelines de CI/CD com GitLab.
</p>
...
[<img align="left" height="94px" width="auto" alt="Prefeitura de Formosa" src="<img width="284" height="100" alt="image" src="https://github.com/user-attachments/assets/97a7f5ba-a0d7-4338-9c19-41a9bfc40f0c" />
"/>](https://formosa.go.gov.br)
**Desenvolvedor FullStack** \
[**Prefeitura de Formosa-GO**](https://formosa.go.gov.br) • Full-time \
Linguagens & Tecnologias: `Spring Boot`, `PostgreSQL`, `React Native`, `Laravel`, `MySQL`, `TypeScript`, `TSX`, `JavaScript`, `Docker`, `GitLab CI/CD`.
Projetos em destaque: [MOBIBUS](https://mobibus.formosa.go.gov.br/login)
<br/>
